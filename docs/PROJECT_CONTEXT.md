...
Один и тот же `G7` может означать `V7` в C major, `V/IV` в D major, secondary dominant или dominant-color chord без классического разрешения. Поэтому абсолютного имени аккорда недостаточно.
