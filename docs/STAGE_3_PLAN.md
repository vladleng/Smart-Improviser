...
> Обновлено 2026-09-24. База: stable 0.3, Stage 2 принят. Реализация Stage 3 не начата.
> Продуктовый workflow согласован; конкретный музыкальный объём/UX и окончательный checklist 0.3a требуют обсуждения до кода. См. [PRODUCT_WORKFLOW.md](PRODUCT_WORKFLOW.md).
...
- [ ] Включить согласованные минорные случаи и harmonic-minor source для минорной доминанты.
...
- [ ] Добавить согласованные upper structures и superimposition/substitution concepts; подготовить расширение для Stage 4.
...
Перед кодом согласовать пять вопросов из PRODUCT_WORKFLOW.md: формат выдачи, музыкальный vocabulary, короткие примеры/прослушивание, ручная трактовка и достаточность текстового UI. Следующий шаг — это обсуждение, а не автоматический запуск 0.3a.
