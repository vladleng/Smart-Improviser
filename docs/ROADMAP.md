...
Stable **0.3**: Stage 0–2 завершены. Следующий этап — Stage 3, реализация не начата.
...
Цели и gates каждой буквы: [STAGE_3_PLAN.md](STAGE_3_PLAN.md), Issue #4. До кода согласуются музыкальный vocabulary, форма выдачи, короткие примеры, ручной выбор трактовки и UI. План не означает принятие или начало реализации checkpoints.
