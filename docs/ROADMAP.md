...
Stable **0.3**: Stage 0–2 завершены. Текущий этап — Stage 3, начат checkpoint 0.3a.
...
Цели и gates каждой буквы: [STAGE_3_PLAN.md](STAGE_3_PLAN.md), Issue #4. Начальная методика согласована: [IMPROVISATION_METHOD.md](IMPROVISATION_METHOD.md). Начат 0.3a; принятие каждой буквы отдельно.
